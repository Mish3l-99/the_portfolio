    ...
    <div className="fixed w-full h-[65px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 shadow-sm shadow-[#ff161669]">
      ...
      >
        ...
        <li className="mob-menu">
            <a onClick={navToggleHandler} href="#home">Home</a>
          </li>
          <li className="mob-menu">
            <a onClick={navToggleHandler} href="#about">About</a>
          </li>
          <li className="mob-menu">
            <a onClick={navToggleHandler} href="#skills">Skills</a>
          </li>
          <li className="mob-menu">
            <a onClick={navToggleHandler} href="#work">Work</a>
          </li>
          <li className="mob-menu">
            <a onClick={navToggleHandler} href="#contact">Contact</a>
          </li>
        </ul>
      </div>
